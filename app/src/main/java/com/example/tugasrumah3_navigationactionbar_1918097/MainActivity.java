package com.example.tugasrumah3_navigationactionbar_1918097;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_vector:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new VectorFragment()).commit();
                break;
            case R.id.nav_galeri:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new GaleriFragment()).commit();
                break;
        }
